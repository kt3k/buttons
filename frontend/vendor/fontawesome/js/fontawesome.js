...
;(function() {
  ...
  function transformForCss(_ref2) {
    ...
    var width = _ref2$width === undefined ? UNITS_IN_GRID : _ref2$width

    var _ref2$height = _ref2.height

    var height = _ref2$height === undefined ? UNITS_IN_GRID : _ref2$height
  ...
  function makeInlineSvgAbstract(params) {
    ...
    var watchable = _params$watchable === undefined ? false : _params$watchable
  ...
  function findIconDefinition(params) {
    ...
    var prefix = _params$prefix === undefined ? 'fa' : _params$prefix
  ...
  var dom = {
    i2svg: function i2svg() {
      ...
      if (IS_DOM) {
        ...
        var node = _params$node === undefined ? DOCUMENT : _params$node
  ...
  var icon = resolveIcons(function(iconDefinition) {
    ...
    var transform =
      _params$transform === undefined ? meaninglessTransform : _params$transform

    var _params$symbol = params.symbol

    var symbol = _params$symbol === undefined ? false : _params$symbol

    var _params$mask = params.mask

    var mask = _params$mask === undefined ? null : _params$mask

    var _params$title = params.title

    var title = _params$title === undefined ? null : _params$title

    var _params$classes = params.classes

    var classes = _params$classes === undefined ? [] : _params$classes

    var _params$attributes = params.attributes

    var attributes = _params$attributes === undefined ? {} : _params$attributes
  ...
  var text = function text(content) {
    ...
    var title = _params$title2 === undefined ? null : _params$title2

    var _params$classes2 = params.classes

    var classes = _params$classes2 === undefined ? [] : _params$classes2
    ...
    var styles = _params$styles2 === undefined ? {} : _params$styles2
  ...
  var counter = function counter(content) {
    ...
    var title = _params$title3 === undefined ? null : _params$title3

    var _params$classes3 = params.classes

    var classes = _params$classes3 === undefined ? [] : _params$classes3
    ...
    var styles = _params$styles3 === undefined ? {} : _params$styles3
